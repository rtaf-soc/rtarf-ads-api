...
namespace ads_api.Migrations
{
    ...
    [Migration("20251021061824_HuntingRule_IsActive_001")]
    partial class HuntingRule_IsActive_001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Its.Ads.Api.Models.MCases", b =>
                {
                    ...
                    b.Property<string>("CasePap")
                        .HasColumnType("text")
                        .HasColumnName("case_pap");

                    b.Property<string>("CaseRefId")
                        .HasColumnType("text")
                        .HasColumnName("case_ref_id");

                    b.Property<string>("CaseSeverity")
                        .HasColumnType("text")
                    ...
                    b.Property<string>("CaseTlp")
                        .HasColumnType("text")
                        .HasColumnName("case_tlp");
                    ...
                    b.Property<string>("ImpactStatus")
                        .HasColumnType("text")
                        .HasColumnName("impact_status");
                    ...
                    b.Property<string>("MergeInto")
                        .HasColumnType("text")
                        .HasColumnName("merge_into");
                    ...
                    b.HasIndex(new[] { "CaseNo" }, "Case_No_Idx1")
                        .IsUnique();

                    b.HasIndex(new[] { "OrgId" }, "Case_OrgId_Idx1");

                    b.HasIndex(new[] { "CaseOwner" }, "Case_Owner_Idx1");
            ...
            modelBuilder.Entity("Its.Ads.Api.Models.MHuntingRule", b =>
                {
                    ...
                    b.Property<string>("LuceneQuery")
                        .HasColumnType("text")
                        .HasColumnName("lucene_query");
            ...
            modelBuilder.Entity("Its.Ads.Api.Models.MMonitoring", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "Monitoring_Name_Idx2")
                        .IsUnique();
            ...
            modelBuilder.Entity("Its.Ads.Api.Models.MNewsFeed", b =>
                {
                    ...
                    b.Property<string>("FeedDateStr")
                        .HasColumnType("text")
                        .HasColumnName("feed_date_str");

                    b.Property<string>("FeedNo")
                        .HasColumnType("text")
